...
class Anasayfa extends BaseController
{
    ...
    {
        return view('tema/header').view('sayfalar/icecekler').view('tema/footer');
    }
    public function yiyecekler()
    {
        return view('tema/header').view('sayfalar/yiyecekler').view('tema/footer');
    }
    ...
    {
        return view('tema/header').view('sayfalar/admin').view('tema/footer');
    }
